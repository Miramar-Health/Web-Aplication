            ...
            <div id="direito">
                <?php
                    if(isset($_GET['link'])){
                        $link = $_GET['link'];
                        $pag[1]="home.php";
                        $pag[2]="formulario_categoria.php";
                        $pag[3]="lista_categoria.php";
                        $pag[4]="formulario_post.php";
                        $pag[5]="lista_post.php";
                        $pag[6]="formulario_noticia.php";
                        $pag[7]="lista_noticia.php";
                        $pag[8]="formulario_banner.php";
                        $pag[9]="lista_banner.php";
                        $pag[10]="formulario_adm.php";
                        $pag[11]="lista_adm.php";
                        $pag[12]="formulario_usuario.php";
