...
//------------------//
     ...
     public function loadById_Categoria($id_categoria)
{
    $sql = new Sql();
    $results = $sql->select("SELECT * FROM categoria WHERE idcategoria =:id", array(':id'=>$id_categoria));
    if (count($results)>0)
    {
