    ...
    <table id="tb_categoria" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#fcfcfc">
        ...
        <tr>
            <td><font size="2" face="verdana, arial" color="#0cc">
                <?php echo $usuario['id']; ?></font></td>
            <td><font size="2" face="verdana, arial" color="#cc0">
                <?php echo  $usuario['nome']; ?></font></td>
            <td><font size="2" face="verdana, arial" color="#c0c">
                <?php echo  $usuario['email']; ?></font></td>
            <td><font size="2" face="verdana, arial" color="#c0c">
                <?php echo  $usuario['login']; ?></font></td>
            <td align="center"><font size="2" face="verdana, arial" color="#fff">
                <a href="<?php echo "alterar_usuario.php?id=".$adm['id'].
                "&nome=".$usuario['nome']."&email=".$usuario['email']."&login=".$usuario['login']; ?>">Alterar</a>
            </font></td>
            <td align="center"><font size="2" face="verdana, arial" color="#fff">
                <a href="<?php echo "op_usuario.php?excluir=1&id=".$usuario['id']; ?>">Excluir</a
            </font></td>
        </tr>
<?php } ?>
    </table>
